...
var errored_letters: Array[String] = []
...
func load_progress():
	...
	if file:
		...
		if data is Dictionary:
			...
			var err = data.get("errored_letters", [])
			if err is Array:
				errored_letters.clear()
				for e in err:
					if e is String:
						errored_letters.append(e)
...
func save_progress():
	var data := {
		...
		"errored_letters": errored_letters,
	}
...
func mark_letter_completed(letter_id: String):
	...
	errored_letters.erase(letter_id)
	save_progress()
...
func mark_letter_errored(letter_id: String):
	if not letter_id in errored_letters:
		errored_letters.append(letter_id)
		save_progress()

func is_letter_errored(letter_id: String) -> bool:
	return letter_id in errored_letters
